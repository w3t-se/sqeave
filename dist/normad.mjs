...
const and__24206__auto__1 = squint_core.re_find(/\/id$/, squint_core.first(data));
if (squint_core.truth_(and__24206__auto__1)) {
const and__24206__auto__2 = (squint_core.count(data)) === (2);
if (and__24206__auto__2) {
const or__24190__auto__3 = squint_core.number_QMARK_(squint_core.second(data));
if (squint_core.truth_(or__24190__auto__3)) {
return or__24190__auto__3;} else {
const or__24190__auto__4 = squint_core.string_QMARK_(squint_core.second(data));
...
return and__24206__auto__1;}} else {
return false;}} else {
return false;}
};
...
const args71 = [];
const len__25229__auto__2 = arguments.length;
let i83 = 0;
while(true){
if ((i83) < (len__25229__auto__2)) {
...
;
const argseq__25490__auto__5 = ((1) < (args71.length)) ? (args71.slice(1)) : (null);
return f6.cljs$core$IFn$_invoke$arity$variadic((arguments[0]), argseq__25490__auto__5);
});
...
const or__24190__auto__12 = squint_core.first(data);
if (squint_core.truth_(or__24190__auto__12)) {
return or__24190__auto__12;} else {
return store9;}
})(), acc);
log.debug("rr: ", res11);
...
const self__25256__auto__15 = this;
return self__25256__auto__15.cljs$core$IFn$_invoke$arity$variadic(G__1013, seq914);
});
return f6;
})();
...
const and__24206__auto__1 = (squint_core.count(entity)) > (0);
...
if (squint_core.truth_((() => {
const and__24206__auto__2 = (squint_core.count(query)) > (1);
if (and__24206__auto__2) {
...
if (squint_core.truth_((() => {
const and__24206__auto__5 = (squint_core.count(query)) === (1);
if (and__24206__auto__5) {
return squint_core.vector_QMARK_(query);} else {
return and__24206__auto__5;}
})())) {
...
const temp__23868__auto__8 = squint_core.get(entity, nk6);
if (squint_core.truth_(temp__23868__auto__8)) {
const data9 = temp__23868__auto__8;
const G__1210 = ({  });
...
if (squint_core.truth_((() => {
const and__24206__auto__1 = squint_core.vector_QMARK_(v);
if (squint_core.truth_(and__24206__auto__1)) {
