...
var get_viewer_user = function (p__19) {
const map__12 = p__19;
const ctx3 = map__12;
...
const and__23227__auto__2 = (viewer_id1) === (acc);
if (and__23227__auto__2) {
const and__23227__auto__3 = !((viewer_id1 == null));
...
alert_error(ctx, e1);
return consola.error(e1);
}

})();

};
var set_field_BANG_ = function (p__21, value, p__22) {
const map__13 = p__21;
const ctx4 = map__13;
...
const path12 = (() => {
const or__23193__auto__13 = append9;
if (squint_core.truth_(or__23193__auto__13)) {
return or__23193__auto__13} else {
return replace10};
...
var add_ident_BANG_ = function (p__23, ident, p__24) {
const map__13 = p__23;
const ctx4 = map__13;
const store5 = squint_core.get(map__13, "store");
const setStore6 = squint_core.get(map__13, "setStore");
...
var remove_ident_BANG_ = function (p__25, path, ident, p__26) {
const map__13 = p__25;
const ctx4 = map__13;
const store5 = squint_core.get(map__13, "store");
const setStore6 = squint_core.get(map__13, "setStore");
...
var add_BANG_ = function (p__27, value, p__28) {
const map__13 = p__27;
const ctx4 = map__13;
const store5 = squint_core.get(map__13, "store");
const setStore6 = squint_core.get(map__13, "setStore");
...
const or__23193__auto__14 = append9;
if (squint_core.truth_(or__23193__auto__14)) {
return or__23193__auto__14} else {
return replace10};
...
var swap_uuids_BANG_ = function (p__29, ident, stream_id) {
const map__12 = p__29;
const ctx3 = map__12;
const store4 = squint_core.get(map__12, "store");
const setStore5 = squint_core.get(map__12, "setStore");
