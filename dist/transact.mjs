...
var get_viewer_user = function (p__20) {
const map__12 = p__20;
const ctx3 = map__12;
...
var set_field_BANG_ = function (p__22, value, p__23) {
const map__13 = p__22;
const ctx4 = map__13;
...
const path12 = (() => {
const or__24252__auto__13 = append9;
if (squint_core.truth_(or__24252__auto__13)) {
return or__24252__auto__13} else {
return replace10}
})();
...
var add_ident_BANG_ = function (p__24, ident, p__25) {
const map__13 = p__24;
const ctx4 = map__13;
const store5 = squint_core.get(map__13, "store");
const setStore6 = squint_core.get(map__13, "setStore");
...
var remove_ident_BANG_ = function (p__26, path, ident, p__27) {
const map__13 = p__26;
const ctx4 = map__13;
const store5 = squint_core.get(map__13, "store");
const setStore6 = squint_core.get(map__13, "setStore");
...
var add_BANG_ = function (p__28, value, p__29) {
const map__13 = p__28;
const ctx4 = map__13;
const store5 = squint_core.get(map__13, "store");
const setStore6 = squint_core.get(map__13, "setStore");
...
const or__24252__auto__14 = append9;
if (squint_core.truth_(or__24252__auto__14)) {
return or__24252__auto__14} else {
return replace10}
})())) {
...
var swap_uuids_BANG_ = function (p__30, ident, stream_id) {
const map__12 = p__30;
const ctx3 = map__12;
const store4 = squint_core.get(map__12, "store");
const setStore5 = squint_core.get(map__12, "setStore");
